...
@Slf4j
class MyStaticView implements View {

    private MediaType textHtmlUtf8 = new MediaType("text", "html", StandardCharsets.UTF_8);
    ...
    public void render(Map<String, ?> model, HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType(textHtmlUtf8.toString());
